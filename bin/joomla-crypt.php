...
/* Usage: 
  echo -n PLAIN-TEXT-PASSWORD | joomla-crypt 
/*

/* BEGIN PASTE FROM public_html/grg/libraries/joomla/user/helper.php */
...
/* END PASTE FROM public_html/grg/libraries/joomla/user/helper.php */

$f = STDIN;
$password = fgets($f);
$salt  = JUserHelper::genRandomPassword(32);
$value = JUserHelper::getCryptedPassword($password, $salt);
echo("$value:$salt\n");
?>
